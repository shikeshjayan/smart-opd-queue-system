...
export const mockDepartments: Department[] = [
  { id: "dep_001", hospitalId: "hos_001", name: "Cardiology", waitingCount: 18, status: "active" },
  { id: "dep_002", hospitalId: "hos_001", name: "General Medicine", waitingCount: 42, status: "active" },
  { id: "dep_003", hospitalId: "hos_001", name: "Orthopedics", waitingCount: 7, status: "active" },
  { id: "dep_004", hospitalId: "hos_001", name: "Pediatrics", waitingCount: 11, status: "active" },
  { id: "dep_005", hospitalId: "hos_002", name: "General Medicine", waitingCount: 31, status: "active" },
  { id: "dep_006", hospitalId: "hos_002", name: "Dermatology", waitingCount: 5, status: "active" },
  { id: "dep_007", hospitalId: "hos_003", name: "General Medicine", waitingCount: 24, status: "active" },
  { id: "dep_008", hospitalId: "hos_003", name: "Pediatrics", waitingCount: 9, status: "active" },
  { id: "dep_009", hospitalId: "hos_004", name: "Cardiology", waitingCount: 13, status: "active" },
  { id: "dep_010", hospitalId: "hos_004", name: "ENT", waitingCount: 6, status: "active" },
  { id: "dep_011", hospitalId: "hos_005", name: "General Medicine", waitingCount: 26, status: "active" },
  { id: "dep_012", hospitalId: "hos_005", name: "Pediatrics", waitingCount: 9, status: "active" },
  { id: "dep_013", hospitalId: "hos_005", name: "Dermatology", waitingCount: 4, status: "active" },
  { id: "dep_014", hospitalId: "hos_006", name: "General Medicine", waitingCount: 19, status: "active" },
  { id: "dep_015", hospitalId: "hos_006", name: "Pediatrics", waitingCount: 6, status: "active" },
  { id: "dep_016", hospitalId: "hos_007", name: "General Medicine", waitingCount: 23, status: "active" },
  { id: "dep_017", hospitalId: "hos_007", name: "Orthopedics", waitingCount: 8, status: "active" },
];
...
export function listHospitalsByDistrict(districtId: DistrictId): Hospital[] {
  return mockHospitals.filter((h) => h.district === districtId);
}
