...
export default function AdminSchedulingPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h1 className="text-2xl font-bold text-ink-900">Appointment Scheduling</h1>
        <p className="mt-1 text-sm text-ink-500">
          Configure working hours, slot rules and supported appointment types per department.
        </p>
      </div>
      ...
      {selectedId && !form && <p className="text-sm text-ink-500">Loading schedule…</p>}
    </div>
  );
}