import type { OpsReport } from "@/services/hospital-ops/types";
...
export function reportToCsv(report: OpsReport): string {
  const lines: string[] = [];
...
export function downloadReportCsv(report: OpsReport): void {
